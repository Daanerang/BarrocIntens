    ...
    <div class="bg-gray-100 border-b border-gray-200 shadow-sm w-full">
        <div class="container mx-auto flex items-center justify-between py-3 px-4 max-w-screen-xl mx-auto">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-yellow-500 rounded-md shadow-lg py-2">
                    <a href="#" class="block px-4 py-2 text-white hover:bg-yellow-700">Dashboard</a>
                    <a href="#" class="block px-4 py-2 text-white hover:bg-yellow-700">Profiel</a>
                    <a href="#" class="block px-4 py-2 text-white hover:bg-yellow-700">Uitloggen</a>
                </div>
            </div>
        </div>
    </div>
